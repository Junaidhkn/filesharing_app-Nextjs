...
export const POST = async (req: Request) => {
	...
	// const msg = {
	// 	to: 'junaidhkn@gmail.com', // Change to your recipient
	// 	from: 'junaidhkn@gmail.com', // Change to your verified sender
	// 	subject: 'asdasd',
	// 	text: 'asdasd',
	...
	try {
		...
		console.log('Errors are falling on me Halp me Allah PLease');
		console.log(error);
...
// 	from: `${emailFrom}`, // your website email address here
